        ...
        <div className="w-full bg-cream/80 rounded-lg p-6 sm:p-10 flex flex-col items-center gap-6">
          ...
          <div className="flex gap-4 w-full">
            <button
              ...
              className="flex-1 py-3.5 rounded-lg text-base font-semibold tracking-wide transition-all duration-200 cursor-pointer bg-dark-brown text-peach hover:opacity-90 active:scale-95"
            >
              Yes
            </button>
            <button
